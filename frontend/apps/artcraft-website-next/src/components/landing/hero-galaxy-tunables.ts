...
export const galaxyLookTuner = defineTunables("galaxyLook", "Galaxy look", {
  ...
  pulseSpeed: {
    ...
    step: 0.01,
    default: 0.12,
    info: "Pulse travel speed — band cycles per second along each arm, moving outward with the cards.",
  },
  pulseWidth: {
    label: "Pulse width",
    min: 0.01,
    ...
    step: 0.005,
    default: 0.05,
    info: "Gaussian width of each pulse as a fraction of its band — small is a comet, large a slow breath.",
  },
  pulseCount: {
    label: "Pulses / arm",
    min: 1,
