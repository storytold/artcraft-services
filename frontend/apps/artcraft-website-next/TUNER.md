...
`src/components/landing/hero-wordmark.tsx`), Galaxy layout, Galaxy mobile
(small-screen spiral profile — replaces the layout dials below its area
threshold), Galaxy motion, Galaxy pointer, Galaxy look (hero galaxy;
