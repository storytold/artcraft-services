  ...
  return (
    <div className="relative min-h-screen w-full p-4 pt-16 bg-dots flex items-start lg:items-center justify-center">
      ...
      <div className="mx-auto max-w-[1920px] w-full h-auto lg:h-[calc(100vh-100px)] min-h-[500px]">
        <div className="flex flex-col lg:flex-row h-full w-full overflow-hidden border border-white/15">
          {/* Media Preview Area */}
          <div className="relative flex-1 bg-black flex items-center justify-center overflow-hidden min-h-[30vh] lg:min-h-0">
            {mediaRecordLoading ? (
