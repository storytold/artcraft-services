...
#[derive(Clone, Debug)]
pub enum FalGptImage2p5SunburstRequestState {
  TextToImage(GptImage2p5SunburstTextToImageRequest),
  EditImage(GptImage2p5SunburstEditImageRequest),
}

impl FalGptImage2p5SunburstRequestState {
...
mod tests {
  ...
  async fn send_text_to_image_webhook() {
    let request = FalGptImage2p5SunburstRequestState::TextToImage(GptImage2p5SunburstTextToImageRequest {
  ...
  async fn send_edit_image_webhook() {
    let request = FalGptImage2p5SunburstRequestState::EditImage(GptImage2p5SunburstEditImageRequest {
