...
/// Cost state for Artcraft GPT Image 2.5 Sunburst. The price table is shared with the other
/// GPT Image 2.5 variant; see `gpt_image_2p5_common_cost`.
#[derive(Clone, Debug)]
pub struct ArtcraftGptImage2p5SunburstCostState {
  inputs: ArtcraftGptImage2p5CostInputs,
}

impl ArtcraftGptImage2p5SunburstCostState {
  pub fn from_request(request: &ArtcraftGptImage2p5SunburstRequestState) -> Self {
