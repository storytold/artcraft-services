...
impl From<String> for ApiClientImageModel {
  fn from(value: String) -> Self {
    match value.as_str() {
      ...
      "gpt_image_2p5_flare" => Self::GptImage2p5Flare,
      "gpt_image_2p5_sunburst" => Self::GptImage2p5Sunburst,
...
impl From<ApiClientImageModel> for String {
  fn from(value: ApiClientImageModel) -> Self {
    match value {
      ...
      ApiClientImageModel::GptImage2p5Flare => "gpt_image_2p5_flare".to_string(),
      ApiClientImageModel::GptImage2p5Sunburst => "gpt_image_2p5_sunburst".to_string(),
...
mod tests {
  ...
  fn every_known_variant_round_trips() {
    let all = [
      ...
      (ApiClientImageModel::GptImage2p5Flare, "gpt_image_2p5_flare"),
      (ApiClientImageModel::GptImage2p5Sunburst, "gpt_image_2p5_sunburst"),
