//! Wan 3.0 ref-to-video through the Kinovi consumer workflow endpoint.
...
pub use crate::requests::workflow_run_task::workflow_run_task::WorkflowRunTaskResponse as GenerateWan3p0RefToVideoResponse;

pub struct GenerateWan3p0RefToVideoArgs<'a> {
  pub request: GenerateWan3p0RefToVideoRequest,
  pub session: &'a KinoviWebSession,
  pub maybe_host_override: Option<KinoviHost>,
}

#[derive(Clone, Debug)]
pub struct GenerateWan3p0RefToVideoRequest {
...
impl Default for GenerateWan3p0RefToVideoRequest {
  fn default() -> Self {
    Self {
      prompt: String::new(),
...
impl KinoviCostCalculatorTrait for GenerateWan3p0RefToVideoRequest {
  ...
  fn calculate_costs(&self, tier: KinoviPricingTier) -> Self::Cost {
    Wan3p0Model::RefToVideo.calculate_costs(self.maybe_output_resolution, self.duration_seconds, tier)
  }
}

impl GenerateWan3p0RefToVideoRequest {
...
pub async fn generate_wan_3p0_ref_to_video(
  args: GenerateWan3p0RefToVideoArgs<'_>,
) -> Result<GenerateWan3p0RefToVideoResponse, KinoviWebError> {
