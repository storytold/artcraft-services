...
#[derive(Clone, Debug)]
pub struct GptImage2p5SunburstEditImageRequest {
  pub params: GptImage2p5EditImageParams,
}

impl FalEndpoint for GptImage2p5SunburstEditImageRequest {
  const ENDPOINT: &str = "openai/gpt-image-2.5/sunburst/edit";
...
mod tests {
  ...
  fn endpoint() {
    ...
    assert_eq!(GptImage2p5SunburstEditImageRequest::get_endpoint(), "openai/gpt-image-2.5/sunburst/edit");
  }

  #[test]
  fn to_raw_request_delegates_to_params() {
    let request = GptImage2p5SunburstEditImageRequest {
