use crate::requests::api::image::edit::gpt_image_2p5_sunburst_edit_image::api::GptImage2p5SunburstEditImageRequest;
use crate::requests::traits::fal_request_cost_calculator_trait::{FalRequestCostCalculator, UsdCents};

impl FalRequestCostCalculator for GptImage2p5SunburstEditImageRequest {
...
mod tests {
  ...
  ) -> GptImage2p5SunburstEditImageRequest {
    GptImage2p5SunburstEditImageRequest {
