use crate::requests::api::image::text::gpt_image_2p5_flare_text_to_image::api::GptImage2p5FlareTextToImageRequest;
use crate::requests::traits::fal_request_cost_calculator_trait::{FalRequestCostCalculator, UsdCents};

impl FalRequestCostCalculator for GptImage2p5FlareTextToImageRequest {
...
mod tests {
  ...
  ) -> GptImage2p5FlareTextToImageRequest {
    GptImage2p5FlareTextToImageRequest {
